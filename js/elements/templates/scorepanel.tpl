...
<table data-match-id="{{=context.id}}">
	...
	<tr class="header">
		...
		<td rowspan="4" class="chart_container"><canvas class="chart" width="64" height="64" style="float: left; width: 64px; height: 64px;"></canvas></td>
	...
	<tr class="blue_world">
		<td class="name">{{=context.world_names.blue}}<span>{{=context.all_world_names.blue}}</span></td>
