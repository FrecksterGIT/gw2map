...
const _toDDHHMMSS = (timeToFormat) => { // eslint-disable-line complexity, max-statements
	var sec_num = timeToFormat, days, hours, minutes, seconds, time = '-';
	if (sec_num) {
...
export {COUNTDOWN_TIME, getPassedTime, getCountdown, diffTime};
